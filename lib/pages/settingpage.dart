        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              const SizedBox(
                  width:
                      4), // Add some spacing between the back text and the title
              Text(
                'Settings',
                style: TextStyle(
                  color: _darkModeEnabled
                      ? Colors.white
                      : Colors
                          .black, // Set app bar text color to white when dark mode is on
                  fontSize: 20,
                  fontFamily: 'Inter',
          ...
          backgroundColor: _darkModeEnabled
              ? Colors.grey[800]
              : Colors.white, // Set app bar color to grey in dark mode
        ),
          ...
          child: Text(
            ...
            style: TextStyle(
              color: _darkModeEnabled
                  ? Colors.white
                  : Colors
                      .black, // Set option text color to white when dark mode is on
              fontSize: 18,
              fontFamily: 'Inter',
              fontWeight: FontWeight.w500,
            ),
            ...
            if (showArrow)
              Icon(Icons.arrow_forward_ios,
                  ...
                  color: _darkModeEnabled
                      ? Colors.white
                      : Colors
                          .black), // Set arrow color to white when dark mode is on
          ],
        ),
      ),
    );
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: _darkModeEnabled
            ? Colors.white
            : Colors
                .black, // Set logout button text color to white when dark mode is on
        backgroundColor: _darkModeEnabled
            ? Colors.grey[800]
            : const Color.fromARGB(255, 255, 255,
                255), // Set logout button background color to grey in dark mode
      ),
      child: const Text(
        'Logout',
        style: TextStyle(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _darkModeEnabled
                    ...
                    : const Color.fromARGB(255, 219, 226,
                        233), // Set logout button background color to grey in dark mode
              ),
              child: const Text(
                'Logout',
                style: TextStyle(
